...
# runtime
# 训练超参数
max_epochs = 140 # 训练 epoch 总数
val_interval = 2 # 每隔多少个 epoch 保存一次权重文件
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='checkpoint/rtmpose-m_simcc-lapa_pt-aic-coco_120e-256x256-762b1ae2_20230422.pth'
        )),
    head=dict(
        type='RTMCCHead',
        in_channels=768,
